...
เราสามารถที่จะลองวิธีคล้ายๆกันในC++ได้หรือเปล่า? constructorของtypeนั้นมีลักษณะเช่นเดียวกันกับclassแบบtemplateเหมือน`optional`ดังนั้นโดยการเปรียบเทียบแล้วเราคงที่จะทำการparameterized`fmap`คู่กับ*template template parameter`F`*นี่คือไวยากรณ์ของมัน
